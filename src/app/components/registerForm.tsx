      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-4 lg:px-20 text-center">
        <div className="bg-white rounded-2xl shadow-2xl flex flex-col lg:flex-row w-full lg:w-2/3 max-w-4xl">
          <div className="w-full lg:w-3/5 p-5">
            ...
            <form onSubmit={handleSubmit} className="py-6 lg:py-10">
              <h2 className="text-2xl lg:text-3xl font-bold text-green-500 mb-2">Sign up Account</h2>
              ...
              <div className="flex flex-col items-center">
                ...
                {error && <p className="text-red-500 my-3 text-start w-full">{error}</p>}

                <button className="border-2 border-green-500 rounded-full px-6 lg:px-12 py-3 inline-block font-semibold text-green-500 hover:bg-green-500 hover:text-white">
                  Register
                </button>

                <Link href={"./"} className="text-gray-400 mt-5 w-full text-end">
